...
{
    /// <summary>
    /// Interaction logic for LoginWithPalmprintView.xaml
    /// </summary>
    public partial class LoginWithPalmprintView : UserControl
    {
        private ViewModels.LoginWithPalmprintViewModel? _vm;

        public LoginWithPalmprintView()
        {
            InitializeComponent();
            DataContextChanged += LoginWithPalmprintView_DataContextChanged;
        }

        private void LoginWithPalmprintView_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            if (_vm != null)
            {
            ...
            _vm = e.NewValue as ViewModels.LoginWithPalmprintViewModel;
        ...
        {
            // BitmapSource is frozen in the VM; marshal asynchronously to keep the capture
            // thread from stalling on the UI per frame.
