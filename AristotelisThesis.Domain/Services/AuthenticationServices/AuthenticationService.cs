...
namespace AristotelisThesis.Domain.Services.AuthenticationServices
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(IAccountService accountService, IPasswordHasher passwordHasher, IFaceImageService faceImageService, IPalmprintImageService palmImageService)
        {
